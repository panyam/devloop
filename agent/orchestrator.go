...
func (o *Orchestrator) StreamLogs(ruleName string, filter string, timeoutSeconds int64, lastNLines int32, writer *gocurrent.Writer[*pb.StreamLogsResponse]) error {
	...
	if logFileExists {
		return o.LogManager.StreamLogs(ruleName, filter, timeoutSeconds, lastNLines, writer)
	}
